...
function SecondBoxes() {
  ...
  return (
    <section>
      ...
      >
        <div className="firstBox2 flex h-[40vh] w-full flex-col justify-end overflow-hidden rounded-2xl bg-gradient-to-r from-[#E8F3FF] via-[#D6EAFE] to-[#C4E0FD] shadow-md md:h-[45vh] lg:h-[50vh]  lg:w-[47%] xl:h-[60vh]">
          <div className="flex h-[30%]  flex-col gap-5 p-5">
            <h1 className="text-2xl font-[600] lg:text-3xl">
              Fast Customer Support
            </h1>
            <p className="w-[85%] text-xs font-[400] md:w-[75%] md:text-sm">
