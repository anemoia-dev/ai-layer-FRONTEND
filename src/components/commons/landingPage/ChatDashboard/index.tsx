...
function SecondChatBox() {
  ...
  return (
    <section
      ...
      className=" mt-32 flex flex-col items-center justify-center  md:h-full"
    >
      <div className=" h-[50vh] w-[90%] overflow-hidden  rounded-3xl shadow-xl  shadow-gray-400 md:h-full">
        {/* Mac Window Buttons */}
        <div
          data-animate="chatNav"
          className="  flex items-center border-b px-10 py-5"
        >
          <div className="flex space-x-2">
            <div className="size-5 rounded-full bg-[#FF5F56]" />
            <div className="size-5 rounded-full bg-[#FFBD2E]" />
            <div className="size-5 rounded-full bg-[#27C93F]" />
          </div>
        </div>

        <div className="flex  h-[90%] flex-row-reverse lg:h-[calc(100vh-2.5rem)] ">
          {/* Sidebar */}
          <div
            data-animate="sideBar"
            className=" hidden  w-72 border-r  p-4 lg:block"
          >
          ...
          >
            ...
            <div className="px-4 py-2">
              <div data-animate="chatList2" className=" space-y-2">
                {[
                  {
                    name: 'عمر',
                    time: '10:30 - 11:30',
          ...
          >
            ...
            <header className="flex h-16 flex-row-reverse items-center justify-between border-b bg-white px-4">
              <div>
                <div className="flex items-center">
                  <button className="lg:hidden" type="submit">
              ...
              <div className="flex justify-between gap-3 rounded-md bg-gray-100 p-2">
                <Mic2Icon />
                <Video />
              </div>
            </header>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="mx-auto max-w-3xl space-y-4">
                <div className="flex justify-end">
                  <div
                    data-animate="chat1"
                    className=" max-w-[80%] rounded-lg bg-white p-3 shadow-sm"
                  >
            ...
            <div className="border-t bg-white p-4">
              <div className="mx-auto flex w-full max-w-3xl items-center justify-center">
                <div className="flex w-full items-center rounded-lg  bg-[#F5F5F5] p-2">
                  <div className="flex space-x-2">
                    <button
                      type="submit"
                    ...
                    <button
                      ...
                      className="rounded-full p-2 hover:bg-gray-200"
                    >
                      <SmilePlus className="size-5 text-gray-500" />
                    </button>
                  </div>
                  <input
                    type="text"
                    placeholder="اكتب رسالتك..."
                    className="w-[70%] flex-1 border-none bg-transparent px-3  text-right focus:outline-none lg:w-full"
                  />
                  <button
                    type="submit"
                    className="mr-2 rounded-md bg-blue-500 px-4 py-1 text-white"
                  >
                    إرسال
                  </button>
                </div>
